...
const int Date::kJulianDayof19700101 = getJulianDayNumber(1970, 1, 1);

Date::Date(int y, int m, int d) : _julianDayNumber(getJulianDayNumber(y, m, d)) {

}

Date::Date(const struct tm& t) : _julianDayNumber(getJulianDayNumber(t.tm_year + 1900, t.tm_mon + 1, t.tm_mday)){
